...
if menu == "Таблица":
    ...
    with st.form("add_form", clear_on_submit=True):
        ...
        with col2:
            # Оставляем поля температур для секторов
    ...
    if submitted:
        ...
        if Плавка_время_заливки and not is_valid_time(Плавка_время_заливки):
            errors.append(f"Некорректный формат времени: {Плавка_время_заливки}")
        ...
        if errors:
            ...
            # Добавляем ID в строку для Excel
